  ...
  const fetchDCs = async () => {
    try {
      const res = await api.get("/loader-documents", {
        params: { type: "DC-FP", page: page, limit: 50 }
      });
      ...
      console.error("Error fetching DC-FP documents:", err);
      setDocuments([]);
    }
  };
            ...
            <table className="product-table entity-table">
              ...
              <tbody>
                {documents.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="7" style={{ textAlign: 'center', padding: '50px', color: '#94a3b8' }}>No DC-FP Documents Found</td>
                  </tr>
                )}
              </tbody>
            </table>
