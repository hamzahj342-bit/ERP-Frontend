      ...
      <div className="rm-page">
        ...
        <div className="card">
          <div className="card-header">
            <h3>Delivery Challan (DC)</h3>
            <button className="add-sale-btn" onClick={() => navigate('/dc-form')}>
              <FaPlus /> ADD NEW DC
            </button>
          </div>
                    ...
                    <tr key={d.id}>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        <div style={{ display: 'flex', gap: '8px', justifyContent: 'center', alignItems: 'center' }}>
                          ...
                          <button onClick={() => navigate(`/dc-view/${d.no}`)} className="primary-btn">
                            <FaEye /> VIEW
                          </button>
                          ...
                          {!d.is_posted && (
                            <>
                              <button onClick={() => navigate(`/dc-form?editId=${d.id}`)} className="edit-btn-action">
                                <FaEdit /> EDIT
                              </button>
